...
public class MessageAdapter extends RecyclerView.Adapter<MessageAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int position) {
        ...
        viewHolder.setGravityLeft();
        Log.d("aaaa",((ChatActivity)mContext).getUsername() +"   " + message.getUsername());
        if(((ChatActivity)mContext).getUsername().equals(message.getUsername())){
