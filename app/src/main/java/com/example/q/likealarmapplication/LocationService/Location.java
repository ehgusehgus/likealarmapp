...
public class Location extends Service {
    ...
    class myServiceHandler extends Handler {
        ...
        public void handleMessage(android.os.Message msg) {
            ...
            PendingIntent pendingIntent = PendingIntent.getActivity(Location.this, 0, intent,PendingIntent.FLAG_UPDATE_CURRENT);
            ...
            //토스트 띄우기
            Toast.makeText(Location.this, "뜸?", Toast.LENGTH_LONG).show();
        }
    };
}
